...
//    }
//
//    public void play(int winningPointsRequired, int healthValue, ArrayList<Question> pathogenList) {
...
//            Question currentThreat = pathogenList.get(randomIndex);
...
//    }
//
//    private boolean checkAnswer(Question pathogen, String userAnswer, int chances) {
//
...
//
//
//    private void askPathogenQuestion(Question currentThreat) {
...
//    private boolean isValidUserInput(Question currentThreat, String userAnswer, int chances) {
...
//    }
//
//    private boolean isCorrect(Question pathogenWithQuestion, String answer) {
